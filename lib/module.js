...
export default function matomoModule (moduleOptions) {
	const { nuxt } = this
	let runtimeConfig = {}
	if (nuxt.options.runtimeConfig && nuxt.options.runtimeConfig.matomo)
		runtimeConfig = nuxt.options.runtimeConfig.matomo
  const options = Object.assign({}, defaults, moduleOptions, runtimeConfig)
