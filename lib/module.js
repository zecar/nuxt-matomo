...
export default function matomoModule (moduleOptions) {
	...
	if (nuxt.options.publicRuntimeConfig && nuxt.options.publicRuntimeConfig.matomo)
		publicRuntimeConfig = nuxt.options.publicRuntimeConfig.matomo
  const options = Object.assign({}, defaults, moduleOptions, publicRuntimeConfig)
